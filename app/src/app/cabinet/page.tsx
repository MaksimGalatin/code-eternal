  ...
  function handleChessClick(row: number, col: number) {
    ...
    if (chessSelected) {
      ...
      if (isLegal) {
        ...
        if(piece==="wP"&&row===0) nb[row][col]="wQ"; // promotion
        ...
        setTimeout(()=>{
          setChessBoard(prev=>{
            ...
            const bNote = "AIfa moves";
            setMoveHistory(h=>[...h, bNote]);
            return after;
          });
          setIsWhiteTurn(true);
        }, 600);
            ...
            <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                ...
                <div className="glass-panel" style={{ padding: "16px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px" }}>
                  <button onClick={() => { setChessBoard(initChessBoard()); setChessSelected(null); setLegalMoves([]); setMoveHistory([]); setIsWhiteTurn(true); setChessStatus("playing"); }}
